...
| 순서  | 주제                                                               | 내용                             | 소요 시간 |
| --- | ---------------------------------------------------------------- | ------------------------------ | ----- |
| 0   | [Prerequisites](0-prerequisites/)                                | ComfyUI 개념, 용어 정리, 사전 설정       | 15분   |
| 1   | [Setup](1-setup/)                                                | ECS 기반 ComfyUI 설치 및 설정         | 15분   |
| 2   | [Workflow 알아보기](2-workflow-basics/)                              | Stable Diffusion 워크플로우 구성 및 실습 | 40분   |
| 3   | [LoRA 실습](3-lora/)                                               | SDXL LoRA 적용 및 Stacking        | 30분   |
| 4   | [워크플로우 실습](4-workflow-practices/)                                | 다양한 워크플로우 실습                   | 120분  |
...
| 5   | [Comfy-pilot](5-comfy-pilot/)                                    | (Optional) Comfy-pilot 데모      | -     |
