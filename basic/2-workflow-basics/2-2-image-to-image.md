...
## 📚 학습 목표
- Image-to-Image와 Text-to-Image의 차이점 이해하기
- denoise 파라미터의 역할과 조정 방법 익히기
- 기존 이미지를 다양한 스타일로 변형하는 실전 기법 학습하기
...
> **초보자 팁:** denoise는 "원본을 얼마나 바꿀까?"를 결정하는 슬라이더입니다. 낮을수록 원본에 가깝고, 높을수록 새롭게 변합니다.
...
> **초보자 팁:** 처음 시도할 때는 denoise=0.75에서 시작하세요. 원본이 너무 많이 보이면 값을 높이고, 너무 바뀌면 값을 낮추세요.
...
> **초보자 팁:** 위 예시들을 그대로 따라해보세요! 자신의 이미지에 적용하면서 denoise 값을 0.1씩 조정하며 차이를 관찰하면 감을 빠르게 익힐 수 있습니다.
...
- [ ] txt2img와 img2img의 차이점을 이해했나요?
- [ ] Load Image와 VAE Encode 노드를 추가하여 워크플로우를 수정했나요?
- [ ] denoise 파라미터를 조정하며 원본 보존도와 변형도의 차이를 경험했나요?
- [ ] 최소 한 가지 실전 예시를 따라해봤나요?
